<?php include 'headinside.php' ?>
  ...
  <div class="courses_banner">
    ...
    <!-- //banner -->
          ...
          <li role="presentation"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">Vison & Mission</a></li>
				  <li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile">Administration</a></li>
				  <li role="presentation"><a href="#profile1" role="tab" id="profile-tab1" data-toggle="tab" aria-controls="profile1">History</a></li>
          <li role="presentation"><a href="#profile2" role="tab" id="profile-tab1" data-toggle="tab" aria-controls="profile1">Don Bosco</a></li>
           <li role="presentation"><a href="#profile3" role="tab" id="profile-tab1" data-toggle="tab" aria-controls="profile1">Educational Philosophy</a></li>
				</ul>
			  ...
			  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
			    <div class="events_box">
			    	...
			    	<div class="event_right">
			    		  <h3>Vision</h3>
						  <p>To innovate and inspire the youth of India.
            ...
            <img src="images/secretary.jpg" class="img-responsive wp-post-image" alt=""/>
            <div></div>
            <figcaption><h3 class="person-title"><a href="event_single.html">Fr.A.Manayil,SDB </a></h3>
              <span class="person-deg">Secretary</span>
...
Secretary <br> </p>
			   ...
			   <div class="events_box">
			     <div class="col-md-3">
            <figure class="team_member">
            <img src="images/principal.jpg" class="img-responsive wp-post-image" alt=""/>
            <div></div>
            <figcaption><h3 class="person-title"><a href="event_single.html">Fr. Amaladoss Ashok,SDB </a></h3>
              ...
              <div class="person-social">
                <ul class="social-person">
                  ...
                  <li><a href="#"><i class="fa fa-youtube"></i></a></li>
			    	...
			    	<div class="event_right">
			    		  <h3><a href="#">Message from Principal</a></h3>
						 <p>Technical Education is the backbone of every nation and is the stepping stone for a country to move into the niche of a developed nation. The south Indian Salesian society has been in the mission of transforming rural India into developed nation by running 768 educational institutions including a university (Assam don Bosco University) and some 40 colleges and 279 academic schools. The Salesian of Don Bosco in India have been catering to over 6 lakhs per year through the oratory and youth centre , school and professional education, boarding and hostels, parishes, social services and work for youth at risk and social communication.
...
<br>
<br>
Outstation students are accommodated in the hostels. Excellent infrastructure by way of Medical facilities, Wi-Fi Internet facilities, Sports facilities and Cafeteria are available in the College campus. Every Roman Catholic Priest is a counselor and a mentor for the student present in the campus. It is the aim of the Management and Faculty who are committed to continually improve and deliver competitive quality technical education to the inspiration and efficiency of the students, their parents and the potential employers for the skilling India.</p>
         ...
         <div class="events_box">
           <div class="col-md-3">
            ...
            <div class="event_right">
                <h3><a href="#">Provincial Message</a></h3>
              <p>Inbox Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum recusandae rem animi accusamus quisquam reprehenderit sed voluptates, numquam, quibusdam velit dolores repellendus tempora corrupti accusantium obcaecati voluptate totam eveniet laboriosam?
Outstation students are accommodated in the hostels. Excellent infrastructure by way of Medical facilities, Wi-Fi Internet facilities, Sports facilities and Cafeteria are available in the College campus. Every Roman Catholic Priest is a counselor and a mentor for the student present in the campus. It is the aim of the Management and Faculty who are committed to continually improve and deliver competitive quality technical education to the inspiration and efficiency of the students, their parents and the potential employers for the skilling India.
              </p>
               <br/><br/>
              </div>
              <div class="event_right">
                <h3><a href="#">Governing Bodies</a></h3>
...
4.  Bro. Mariadoss Maria Arockiaraj, Sdb <br>
  Administrator & Principal ITI  </p>
              
              </div>
              <br/><br/>
              <h3>ORGANIZATIONAL CHART</h3>
              <img src="images/chart.png" width="950" height="461" />
               </div>
          ...
          <div class="events_box">
             <div class="container">
            <div class="event_right">
                <h3><a href="#">HISTORY OF DON BOSCO TECHNICAL CAMPUS</a></h3>
...
The year 1973 was another landmark in the history of the Institute, with the recognition by the Government of India, the I.T.I. trades of Fitter and Turner. In 1977, we were fortunate to have 2 more new trades recognized Welder and Machinist. The welder course has been shifted to St. Joseph, Katpadi. In 1984, two more new trades namely Electrician and Draughtsman (Mech.) were started and have been affiliated to N.C.V.T. In August 1987, the trade of Electronic Mechanic was started. This also has been affiliated to N.C.V.T.</p>
         ...
         <div class="events_box">
            ...
            <div class="event_right">
                <h3><a href="#">EVOLUTION OF DON BOSCO POLYTECHNIC COLLEGE</a></h3>
...
<br>
<br>
In December 2011 Rev. Fr. Ashok Amaladoss applied for Don Bosco Polytechnic College after the inspection by AICTE and DOTE members, the approval was granted for the year 2014-2015. Thus the college was established and functioning</p>
...
The system of education that emerged from these principles of Don Bosco is popularly known as the Preventive System and is the system that is followed in Don Bosco University. Joseph Zoppi, the Swiss educationist said, "If there ever existed a method of education adapted to inspire confidence and love, it is the method of Don Bosco." The system aims at creating a generation of young men and women steeped not only in sound knowledge-based education but also in a strong value-based education for life.</p>
        ...
        <div role="tabpanel" class="tab-pane fade" id="profile3" aria-labelledby="profile-tab">
          <div class="events_box">
             <div class="container">
            <div class="event_right">
                <h3><a href="#">Educational Philosophy</a></h3>
...
<br>
 ...
 1. A preferential option for young people, especially those coming from the lower strata of society.</li> <br> 
