...
Fr.A.Manayil SDB <br>
Secretary <br> </p></div><div class="clear"></div>

<h3>Principal</h3>
					    <div class="image group">
							   <div class="grid images_3_of_1">
								  <img src="images/principal_image.jpg" alt="">
					  </div>
									<div class="grid span_2_of_1">
...
<br>
<br>
Outstation students are accommodated in the hostels. Excellent infrastructure by way of Medical facilities, Wi-Fi Internet facilities, Sports facilities and Cafeteria are available in the College campus. Every Roman Catholic Priest is a counselor and a mentor for the student present in the campus. It is the aim of the Management and Faculty who are committed to continually improve and deliver competitive quality technical education to the inspiration and efficiency of the students, their parents and the potential employers for the skilling India.</p></div><div class="clear"></div></div>
<h3>Province</h3>
					    <div class="image group">
							   <div class="grid images_3_of_1">
								  <img src="images/img_block.png" alt="">
					  </div>
									<div class="grid span_2_of_1">
										<h4>Provincial Message</h4>
											<p>Inbox Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum recusandae rem animi accusamus quisquam reprehenderit sed voluptates, numquam, quibusdam velit dolores repellendus tempora corrupti accusantium obcaecati voluptate totam eveniet laboriosam?</p></div><div class="clear"></div></div>
											<br/>
...
<h3>Organizational Chart</h3><br/>
											...
											<img src="images/chart.png" width="1236" height="461" />
