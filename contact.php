<?php include 'headinside.php' ?>
  ...
  <div class="courses_banner">
    <div class="container">
      ...
      <p class="description">
            ...
            No.106, D'Castor Road, Basin Bridge,
            Chennai - 600012.<br>
  ...
  <div class="container">
        ...
        <div class="map">
       <iframe width="100%" height="520" frameborder="0" src="https://maps.google.co.in/maps/ms?msa=0&amp;msid=207087629318280677330.0004d82b443e7230fe490&amp;hl=en&amp;ie=UTF8&amp;t=m&amp;ll=13.103304,80.265942&amp;spn=0.009196,0.02635&amp;z=15&amp;output=embed" marginwidth="0" marginheight="0" scrolling="no"></iframe>
      </div>
      <br/>
      <div class="wrapper">
        <div class="col_1">
          ...
          <div class="box">
            <p class="marTop9">Don Bosco Polytechnic College,<br>No.106, D'Castor Road, Basin Bridge,<br>Chennai - 600012.</p>
          </div>
        </div>
        ...
        <div class="col_2">
          ...
          <div class="box">
            <p class="marTop9">044-26673821<br>044-26673366</p>
          </div>
        </div>
        ...
        <div class="col_3">
          ...
          <div class="box">
            <p class="m_6">principal@dbtechcampus.ac.in </p>
          </div>
        ...
        <div class="col_3">
          <i class="fa fa-envelope icon2"></i>
          <div class="box">
            <p class="m_6"> <a href="www.dbtechcampus.ac.in" class="link4">www.dbtechcampus.ac.in</a></p>
          </div>
